                ...
                <div class="nav">
                    ...
                    <div class="collapse" id="collapseStores" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            ...
                            <a class="nav-link" href="layout-sidenav-light.html">Staff List</a>
                        </nav>
                    </div>
                    ...
                    <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                            <a class="nav-link" href="layout-static.html">Notice</a>
                            ...
                            <div class="collapse" id="pagesCollapseMyPage" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="401.html">Profile</a>
                                    <a class="nav-link" href="404.html">Time Table</a>
                                    <a class="nav-link" href="500.html">Suggestions</a>
                                </nav>
                            </div>
                        </nav>
                    </div>
					...
					<div class="collapse" id="collapseCharts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="layout-static.html">Order</a>
                            <a class="nav-link" href="layout-sidenav-light.html">Customer</a>
                            <a class="nav-link" href="layout-sidenav-light.html">Download</a>
                        </nav>
                    </div>
