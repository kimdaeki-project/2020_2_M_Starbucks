							...
							<li class="gnb_nav02">
								...
								<div class="gnb_sub_wrap" style="display:none;">
									...
									<div class="gnb_sub">
										<div class="gnb_sub_inner">
											<ul>
												<li class="gnb_sub_ttl"><a href="/menu/menuDrink">음료</a></li>
											...
											<ul>
												<li class="gnb_sub_ttl"><a href="menu/menuFood">푸드</a></li>	
												<li><a href="#">브레드</a></li>
												<li><a href="#">케이크</a></li>
											...
											<ul>
												<li class="gnb_sub_ttl"><a href="menu/menuProduct">상품</a></li>
												<li><a href="#">머그</a></li>
												<li><a href="#">글라스</a></li>
											...
											<ul>
												<li class="gnb_sub_ttl"><a href="menu/menuCoffee">커피</a></li>
